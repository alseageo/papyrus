...
class GeoJSONEncoder(PyGFPEncoder):
    ...
    # for numeric columns, datetime.date for dates, and uuid.UUID for
    # PostgreSQL UUID columns. simplejson doesn't deal with these types.
    # This class provides a simple encoder to deal with objects of these types.
